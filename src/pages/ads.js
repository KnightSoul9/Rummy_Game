  ...
  return (
    <div className="min-h-screen bg-customBeige relative overflow-hidden">
      ...
      <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 mb-6 sm:mb-10 transform hover:scale-[1.02] transition-all duration-300">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-gray-800 border-b pb-4">
            For Game Developers & Operators
          </h2>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 transform hover:scale-[1.02] transition-all duration-300">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6 sm:mb-8 text-gray-800 border-b pb-4">
            Contact Details
          </h2>
