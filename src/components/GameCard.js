    ...
    <div
      ...
      className={`relative ${
        darkMode
          ...
          : "bg-gradient-to-br from-gray-100/90 via-gray-50/80 to-gray-100/90"
      } p-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 w-full overflow-hidden group cursor-pointer`}
    >
      ...
      {/* Game Name */}
      <h3
        className={`text-lg font-semibold mt-2 text-center truncate ${
          darkMode
            ? "text-white"
